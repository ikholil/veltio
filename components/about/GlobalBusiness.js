    ...
    return (
        <div className='max-w-[1296px] mx-auto py-10 md:my-[120px]'>
            <div className="grid grid-cols-12 mx-3 2xl:mx-0 2xl:gap-5 items-center">
                <Fade left>
                <div className='col-span-12 mx-3 xl:mx-0 flex justify-center lg:col-span-5 relative'>
                ...
                <div className="col-span-12 lg:col-span-7">
                    <h2 className='mx-4 lg:mx-0 mb-16 md:mb-[87px] text-4xl md:text-[57px] leading-tight font-bold'>Best Global <span className='text-[#F112A2]'>Business</span> Conference</h2>
                    <div className='grid grid-cols-12 gap-3 xl:gap-5'>
                        {
                            aboutBusiness.map(item => (
                                <div key={item.id} className="col-span-12 mx-4 min-h-0 h-full flex items-start gap-5 md:col-span-6 ">
                                    ...
                                    <div> 
                                        <h3 className='text-lg lg:text-2xl font-bold mb-1 text-[#222]'>{item.title}</h3>

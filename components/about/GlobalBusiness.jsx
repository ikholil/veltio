...
const GlobalBusiness = () => {
  return (
    <div className="max-w-[1296px] mx-auto my-16 md:mt-[120px] md:pb-[190px]">
      <div className="grid grid-cols-12 mx-3 2xl:mx-0 2xl:gap-5 items-center">
          ...
          <div className="col-span-12 lg:col-span-8">
            <h2 className="mx-4 lg:mx-0 mb-10 md:mb-[64px] text-4xl md:text-[57px] leading-tight font-bold">
              ...
              {aboutBusiness.map((item) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm lg:text-lg text-[#444]">
                      {item.desc}
                    </p>
                  </div>
                </div>

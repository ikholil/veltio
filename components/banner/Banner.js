...
const Banner = () => {
  return (
    <div>
      <div className="bg-[url('/image/banner/banner-bg.png')] bg-no-repeat bg-cover banner-bg w-full lg:h-[95vh]  relative">
        <Fade bottom>
        ...
        <div className="max-w-[1296px] mx-auto z-20 flex flex-col md:flex-row lg:h-[80vh] h-full lg:pt-10 items-center ">
          <Fade bottom>
            <div className="z-10 pt-32 md:pt-48 xl:pt-0 px-4 xl:px-0">
              <p className="text-white text-2xl font-semibold mb-2 ">
                Professional
              </p>
              <h1 className="font-bold leading-tight text-white text-5xl lg:text-[76px]">
              ...
              <button className="px-16 mt-8 py-4 mb-10 lg:mb-0  rounded-md bg-white primary-color font-bold">
                Get Ticket
              </button>
            </div>
          </Fade>
          ...
          <Fade delay={500} bottom>
            <div className=" z-10 md:-right-14 -bottom-2 md:-bottom-20 2xl:-bottom-20 relative">
              <Image
                src={bannerImg}
                className=""
                alt="bannger image"

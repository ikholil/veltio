...
const TopBanner = (props) => {
  return (
    <div className="bg-[url('/image/banner/banner-bg2.png')] bg-no-repeat bg-cover relative">
      ...
      <div className="flex  relative z-10 max-w-[1296px] mx-auto items-center h-full pb-14 md:pb-[113px] pt-[116px] md:pt-[230px]">
   
        <div className="mx-5">
          <h1 className="text-4xl md:text-[76px] mb-5 md:mb-[30px] text-white font-bold">
            {props.text}
          </h1>

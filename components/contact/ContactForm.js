  ...
  return (
    <div className="relative">
      ...
      <div className="  max-w-[1296px] mx-3 md:mx-auto h-full z-10 relative">
          <h2 className="text-center text-4xl pt-[120px] md:text-[57px] font-extrabold mb-7">
         ...
         <input type="text" placeholder="Full Name" className="p-5 w-full rounded-md mb-4" />
            ...
            <textarea rows='8'  placeholder="Type a Message" className="mb-[53px] p-5 w-full rounded-md" />

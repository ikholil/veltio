  ...
  return (
    <div className="relative">
      ...
      <div className="text-center">
          <h2 className="text-center font-extrabold mt-5 md:mt-24 mb-10 text-2xl md:text-[57px]">
       ...
       <Fade bottom>
       <div className="grid mx-3 md:mx-0 grid-cols-12 mb-5 :mx-auto gap-4">
        ...
        <div className="flex justify-center mb-5 md:mb-20 gap-2">
            <button className="bg-[#F112A2] px-2 text-white border border-[#F112A2]">1</button>
            <button className="text-[#F112A2] px-2 border border-[#F112A2]">2</button>
            <button className="text-[#F112A2] px-2 border border-[#F112A2]"> {">"}</button>
        </div>
      </div>
    </div>
  );

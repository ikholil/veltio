...
const Social = (props) => {
    return (
        <div className='flex justify-center gap-4'>
            ...
            <GrLinkedinOption className={`cursor-pointer hover:text-white hover:border-[#F112A2] duration-500   border-[1px] rounded-full p-2 transition-colors hover:bg-[#F112A2] ${props.classes}`} size={props.size} />
        </div>
    );
};

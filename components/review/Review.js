  ...
  return (
    <div>
      <div className="relative">
        ...
        <Fade bottom>
        <div className="pb-24  max-w-[1296px] mx-auto z-10 relative">
          ...
          <div className="flex flex-col mx-2 md:mx-0 flex-wrap md:flex-row gap-6 justify-center items-center">
           {
            reviews.map(review => (
              <div key={review.id} className="flex flex-col rounded-sm shadow-lg p-7 text-center bg-white md:w-[400px]">
                <div>
                  <Image src={review.image} width={100} height={130} alt="review image" />
                </div>

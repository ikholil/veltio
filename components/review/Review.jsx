      ...
      <div className="relative">
        ...
        <div className="pb-[60px] md:pb-[120px] pt-16 md:pt-[127px]  max-w-[1296px] mx-auto z-10 relative">
          ...
          <div className="flex flex-col mx-2 md:mx-0 flex-wrap md:flex-row gap-6 justify-center items-center">
           {
            reviews.map(review => (
              <div key={review.id} className="flex flex-col rounded-sm hover:shadow-xl cursor-pointer transition-all duration-300 pb-[30px] px-3 md:px-[30px] pt-1 text-center bg-white w-[300px] md:w-[400px]">
                <div className="pt-4">
